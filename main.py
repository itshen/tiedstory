...
_TOPICS = {
    "loss": {
        ...
        "title": "失恋难过",
        "color": "pink",
        "description": "失恋了，有话想说又不知道跟谁说？在 TiedStory 最火的匿名树洞，完全隐私保障，说出那些没来得及说的话。",
    ...
    "lonely": {
        ...
        "title": "孤独无助",
        "color": "blue",
        "description": "孤独不是没有人，而是没有人真的懂你。TiedStory 最火匿名树洞，完全隐私保障，陌生人的陪伴让你不再一个人。",
    ...
    "anxiety": {
        ...
        "title": "焦虑压力",
        "color": "purple",
        "description": "睡不着，脑子停不下来，对未来的恐惧压得人喘不过气。TiedStory 最火匿名树洞，完全隐私保障，把焦虑说出来。",
    ...
    "work": {
        ...
        "title": "工作委屈",
        "color": "orange",
        "description": "被老板骂、被同事排挤、努力没人看见……TiedStory 最火匿名树洞，完全隐私保障，职场里的委屈说出来吧。",
    ...
    "sad": {
        ...
        "title": "莫名想倾诉",
        "color": "blue",
        "description": "说不清楚为什么，就是想倾诉。TiedStory 最火匿名树洞，完全隐私保障，不需要解释原因，有话就说出来。",
